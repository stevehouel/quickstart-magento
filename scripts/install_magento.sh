...
yum -y update
yum install -y php php-cli php-devel php-common php-mysqlnd php-pdo php-opcache php-xml php-mcrypt php-gd php-soap php-redis php-bcmath php-intl php-mbstring php-json php-iconv php-fpm php-zip mysql
